...
componentWillMount(){
  ...
  _renderItem = ({item,index}) => (
            <View>
              <TouchableOpacity  style={styles.childstyle}>
                ...
                <TouchableOpacity style={{alignItems:'center',justifyContent:'center',width:'17%'}} 
                  onPress={()=>this.checkoutsingle(this.state.email[index])}>
                  <Image source={add}></Image>
                </TouchableOpacity>
                <TouchableOpacity style={{alignItems:'center',justifyContent:'center',width:'17%'}} 
                  onPress={()=>this.deleteentry(this.state.email[index])}>
                  <Image source={del}></Image>
                </TouchableOpacity>
  ...
  render() {
    ...
    <View style={styles.container}>
      <Header backgroundColor="#fac1b8" centerComponent={{text:'Bucket', style:{color:'#fff',fontSize:20} }} 
      ...
      <Nav navigate={this.props.navigation.navigate}></Nav>
        ...
        justifyContent: 'center',width:"100%",height:"7%"}}>
            <TouchableOpacity style={{marginRight:"4%",borderBottomWidth:6,borderBottomColor:"#fac1b8"}}
            onPress={()=>this.checkout()}>
            <Text>Checkout All</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{marginLeft:"4%",borderBottomWidth:6,borderBottomColor:"#fac1b8"}}
